...
CATEGORY_ORDER = [
    ("Identity",      ["nintendo", "account", "uid", "pid", "opponent",
                       "friend", "friends", "ban"]),
    ("Network base",  ["network", "ip", "address", "socket", "p2p", "port",
                       "url", "band"]),
    ("NEX core",      ["nex", "prudp", "rmc", "gathering"]),
    ("NEX session",   ["session", "joinsession", "matchmakesession",
                       "joinmatchmakesession", "leavematchmakesession",
                       "updatesession", "participat", "join", "kick"]),
    ("NEX protocol",  ["protocol", "protocolid", "method", "parameter",
                       "rendezvous", "authentication", "notification",
                       "login", "register", "logout"]),
    ("Pia",           ["pia", "piacommon", "piasession", "piatransport",
                       "pialocal", "relay", "proxy", "transport", "mesh",
                       "migration", "migrate", "host", "joint", "lan",
                       "local"]),
    ("Crypto",        ["aes", "key", "handshake", "nonce", "mac", "hmac",
                       "digest", "verify", "signature", "token", "ticket",
                       "rc4", "encrypt"]),
    ("Connection",    ["connect", "disconnect", "retry", "timeout", "error",
                       "invalid"]),
    ("Matchmaking",   ["matching", "matchmaking", "rating", "vip", "gsp",
                       "arena", "room"]),
    ("Battle/state",  ["melee", "ready", "wait", "waiting", "result", "replay",
                       "rematch", "scene", "state", "statemachine",
                       "transition", "phase", "gamemode", "chara_select",
                       "stage_select", "menu", "home", "quit", "victory",
                       "defeat", "battle_start", "battle_end"]),
    ("UI/misc",       ["popup", "block", "spect"]),
    ("Hash/Lua",      ["hash", "hash40", "phx", "lua", "lua_bind", "online"]),
]
