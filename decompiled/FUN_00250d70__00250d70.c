...

{
  ...
  if ((uVar5 & 1) == 0) {
    ...
    auVar13 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_b8,0x14,sVar7,uVar9,param_12,param_13,param_14,param_15);
    sVar8 = 4;
    ...
    *(undefined8 *)(DAT_052a6b78 + 0x98) = DAT_052a6c10;
