...
LAB_00269788:
    ...
    auVar14 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_d0,7,sVar7,plVar8,puVar9,uVar10,param_14,param_15);
    sVar7 = 4;
    ...
    if (local_c8 == '\0') {
      local_54 = (int)((ulong)(param_11[1] - *param_11) >> 3) * -0x42108421;
      sVar7 = 4;
      ...
      for (lVar11 = *param_11; lVar11 != lVar1; lVar11 = lVar11 + 0xf8) {
        auVar14 = FUN_002897e0(auVar14,param_2,param_3,param_4,param_5,param_6,param_7,
      ...
      if (local_c8 == '\0') {
        ...
        if (local_c8 == '\0') {
          ...
          *(undefined8 *)(DAT_052a6f30 + 0x30) = DAT_052a6fd0;
