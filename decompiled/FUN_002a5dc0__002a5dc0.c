...

{
  ...
  if (lVar19 == 0) {
    ...
    FUN_002a64c0(auVar31,param_2,param_3,param_4,param_5,param_6,param_7,param_8,(int *)&local_340,
  ...
  *(undefined4 *)(param_8 + 0x150) = 0;
  ...
  local_1a0[0] = 0;
  FUN_002a65f0(extraout_q0_01,param_2,param_3,param_4,param_5,param_6,param_7,param_8 + 0x188,
...
LAB_002a5fcc:
  ...
  if (lVar20 != 0) {
    ...
    auVar31 = FUN_001b48e0(extraout_q0_05,param_2,param_3,param_4,param_5,param_6,param_7,
                           (long)&local_1f0,s_mnu_anyone_rule_edit_charge_off_0435a9cd + 0x12,
    ...
    local_340 = s_set_parts_oppo_tag_042f7700;
    local_160[0] = 0;
    local_15c = local_32c;
    local_32c = uVar12;
    local_32b = local_15b;
