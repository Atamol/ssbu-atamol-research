...

{
  ...
  if (plVar8 != (long *)0x0) {
    do {
      bVar3 = (uint)*(ushort *)(plVar8 + 4) < ((uint)param_9 & 0xffff);
      if (!bVar3) {
        plVar7 = plVar8;
      }
      plVar8 = (long *)plVar8[bVar3];
    } while (plVar8 != (long *)0x0);
    if ((plVar7 != plVar6) && ((uint)*(ushort *)(plVar7 + 4) <= ((uint)param_9 & 0xffff))) {
      lVar5 = plVar7[5];
      goto LAB_0023b5bc;
    }
  }
