...
LAB_00251388:
    ...
    auVar12 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_c0,0x16,sVar7,uVar5,lVar8,param_13,param_14,param_15);
    sVar7 = 8;
    ...
    if (local_b8 == '\0') {
      ...
      if (local_b8 == '\0') {
        ...
        *(undefined8 *)(DAT_052a6b78 + 0xa8) = DAT_052a6c20;
