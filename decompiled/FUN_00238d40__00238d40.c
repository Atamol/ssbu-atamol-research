...
// name:      FUN_00238d40
// mangled:   
// signature: undefined __cdecl FUN_00238d40(undefined1[16] param_1, undefined1[16] param_2, float param_3, undefined1[16] param_4, undefined1[16] param_5, undefined1[16] param_6, undefined1[16] param_7, undefined8 param_8, undefined8 param_9, size_t param_10, undefined8 param_11, undefined8 param_12, undefined8 param_13, undefined8 param_14, undefined8 param_15)


/* WARNING: Removing unreachable block (ram,0x00238e28) */
/* WARNING: Removing unreachable block (ram,0x00238e3c) */

void FUN_00238d40(undefined1 param_1 [16],undefined1 param_2 [16],float param_3,
...

{
  ...
  if (*DAT_052a3da8 != '\0') {
    ...
    if (uVar4 != 0) {
      ...
      plVar9 = (long *)(*(long *)(lVar3 + (ulong)uVar4 * 8) + 0x88);
    }
  }
  if (*plVar9 == 0) {
    plVar9 = (long *)0x0;
...
LAB_00238e4c:
  if ((iVar10 == 0) && (*(char *)((long)plVar9 + 0xc) == '\0')) {
    *(undefined1 *)((long)plVar9 + 0xc) = 1;
                    /* WARNING: Could not recover jumptable at 0x00238e7c. Too many branches */
