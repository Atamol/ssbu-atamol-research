      ...
      do {
        ...
        if (uVar9 <= param_9) {
          if (uVar9 < param_9) {
            ...
            if (plVar7 != (long *)0x0) {
              uVar9 = plVar7[4];
              goto joined_r0x0022dc00;
            }
          }
          lVar6 = *plVar8;
          goto joined_r0x0022dc78;
        }
        plVar7 = (long *)*plVar12;
        plVar8 = plVar12;
        if (plVar7 == (long *)0x0) goto LAB_0022dc6c;
        uVar9 = plVar7[4];
      } while( true );
    }
    uVar10 = 0;
...
joined_r0x0022dc78:
  if (lVar6 == 0) {
    ...
    *plVar8 = (long)plVar5;
    if (**(long **)(param_8 + 0x88) != 0) {
      *(long *)(param_8 + 0x88) = **(long **)(param_8 + 0x88);
      plVar5 = (long *)*plVar8;
    }
    FUN_003e5af0(*(long **)(param_8 + 0x90),plVar5);
    *(long *)(param_8 + 0x98) = *(long *)(param_8 + 0x98) + 1;
  }
  uVar10 = 1;
LAB_0022dcc8:
