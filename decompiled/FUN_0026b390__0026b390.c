...
// name:      FUN_0026b390
// mangled:   
// signature: uint __cdecl FUN_0026b390(undefined1[16] param_1, undefined1[16] param_2, float param_3, undefined1[16] param_4, undefined1[16] param_5, undefined1[16] param_6, undefined1[16] param_7, size_t param_8, long * param_9, long * param_10, long * param_11, long * param_12, undefined1 * param_13, undefined1 * param_14, ulong param_15, undefined8 param_16)


uint FUN_0026b390(undefined1 param_1 [16],undefined1 param_2 [16],float param_3,
                 undefined1 param_4 [16],undefined1 param_5 [16],undefined1 param_6 [16],
                 undefined1 param_7 [16],size_t param_8,long *param_9,long *param_10,long *param_11,
                 long *param_12,undefined1 *param_13,undefined1 *param_14,ulong param_15,
                 undefined8 param_16)

{
  ...
  if (*DAT_052a3da8 != '\0') {
    puVar3 = (uint *)FUN_01717c00(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,
                                  *DAT_052a3db8,extraout_x1,(size_t)plVar6,plVar8,plVar9,puVar10,
                                  puVar11,uVar12);
    uVar15 = *puVar3;
    if (uVar15 != 0) {
  ...
  auVar16 = FUN_0022b580(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,
                         *(ushort *)(param_8 + 0x48),1,plVar8,plVar9,puVar10,puVar11,uVar12);
  uVar4 = FUN_0022b490(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,
                       param_9,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12);
  if ((uVar4 & 1) == 0) {
    param_15 = 0;
LAB_0026b50c:
    bVar2 = false;
    ...
    auVar16 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_e0,0x2c,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12);
    sVar7 = 4;
    ...
    FUN_001d0560(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,local_6c,4
                 ,plVar8,plVar9,puVar10,puVar11,uVar12);
    lVar1 = param_10[1];
    ...
    for (lVar13 = *param_10; lVar13 != lVar1; lVar13 = lVar13 + 0x20) {
      auVar16 = FUN_0028feb0(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,
                             (long)&lStack_e0,lVar13,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12);
    }
    if (local_d8 == '\0') {
      ...
      FUN_001d0560(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,local_6c
                   ,4,plVar8,plVar9,puVar10,puVar11,uVar12);
      lVar1 = param_11[1];
      ...
      if (local_d8 == '\0') {
        local_6c[0] = (int)((ulong)(param_12[1] - *param_12) >> 4) * 0x286bca1b;
        sVar7 = 4;
        FUN_001d0560(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,
                     local_6c,4,plVar8,plVar9,puVar10,puVar11,uVar12);
        lVar1 = param_12[1];
        auVar16 = extraout_q0_03;
        for (lVar13 = *param_12; lVar13 != lVar1; lVar13 = lVar13 + 0x130) {
          auVar16 = FUN_0028bab0(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,
                                 (long)&lStack_e0,lVar13,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12)
          ;
        }
        if (local_d8 == '\0') {
          FUN_001d0730(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_e0,
                       param_13,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12);
          if (local_d8 == '\0') {
            FUN_001d0730(extraout_q0_04,param_2,param_3,param_4,param_5,param_6,param_7,
                         (long)&lStack_e0,param_14,sVar7,plVar8,plVar9,puVar10,puVar11,uVar12);
            if (local_d8 == '\0') {
              auVar16 = extraout_q0_05;
              if (param_9 != (long *)0x0) {
                auVar16 = FUN_0022b530(extraout_q0_05,param_2,param_3,param_4,param_5,param_6,
                                       param_7,(long)param_9,param_15,sVar7,plVar8,plVar9,puVar10,
                                       puVar11,uVar12);
                auVar16 = FUN_0022b530(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,
                                       (long)param_9,param_16,sVar7,plVar8,plVar9,puVar10,puVar11,
                                       uVar12);
              }
              *(undefined8 *)(DAT_052a6f30 + 0x158) = DAT_052a7028;
              if ((*(char *)(param_8 + 0x70) != '\0') &&
                 (bVar2 = FUN_0022b600(param_8,0x10), auVar16 = extraout_q0_06, bVar2)) {
                bVar2 = true;
                goto LAB_0026b678;
              }
              uVar4 = FUN_0022a8f0(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,param_8,
                                   (long)param_9,(size_t)&lStack_e0,plVar8,plVar9,puVar10,puVar11,
                                   uVar12);
              param_15 = uVar4 & 0xffffffff;
              goto LAB_0026b50c;
            }
            local_6c[0] = -0x7ffefff6;
            auVar16 = operator=((undefined4 *)alStack_158,local_6c);
            plVar6 = alStack_158;
          }
          else {
            local_6c[0] = -0x7ffefff6;
    ...
    FUN_001d0d90(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,(long)param_9,plVar6,sVar7,
                 plVar8,plVar9,puVar10,puVar11,uVar12);
    bVar2 = false;
    param_15 = 1;
  }
LAB_0026b678:
  ...
  if (bVar2) {
    uVar5 = FUN_0022a8f0(auVar16,param_2,param_3,param_4,param_5,param_6,param_7,param_8,
                         (long)param_9,(size_t)&lStack_e0,plVar8,plVar9,puVar10,puVar11,uVar12);
    uVar15 = (uint)uVar5;
  }
