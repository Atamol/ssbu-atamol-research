...
LAB_002693d8:
    ...
    auVar14 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_d0,0x27,sVar7,plVar8,puVar9,uVar10,param_14,param_15);
    sVar7 = 4;
    ...
    if (local_c8 == '\0') {
      local_54 = (int)((ulong)(param_11[1] - *param_11) >> 3) * -0x3f03f03f;
      sVar7 = 4;
      ...
      for (lVar11 = *param_11; lVar11 != lVar1; lVar11 = lVar11 + 0x208) {
        auVar14 = FUN_00289600(auVar14,param_2,param_3,param_4,param_5,param_6,param_7,
      ...
      if (local_c8 == '\0') {
        ...
        if (local_c8 == '\0') {
          ...
          *(undefined8 *)(DAT_052a6f30 + 0x130) = DAT_052a6fc8;
