...
LAB_0026c530:
    ...
    auVar14 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_c0,0x13,sVar8,puVar9,uVar10,param_13,param_14,param_15);
    sVar8 = 4;
    local_44 = (undefined4)((ulong)(param_10[1] - *param_10) >> 3);
    ...
    for (lVar11 = *param_10; lVar11 != lVar1; lVar11 = lVar11 + 8) {
      sVar8 = 8;
      FUN_001d0560(auVar14,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0,lVar11,8
    ...
    if (local_b8 == '\0') {
      ...
      if (local_b8 == '\0') {
        ...
        *(undefined8 *)(DAT_052a6f30 + 0x90) = DAT_052a7050;
