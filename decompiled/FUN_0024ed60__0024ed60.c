...

{
  ...
  if (*DAT_052a3da8 != '\0') {
    puVar3 = (uint *)FUN_01717c00(auVar12,param_2,param_3,param_4,param_5,param_6,param_7,
                                  *DAT_052a3db8,extraout_x1,sVar7,uVar5,uVar8,param_13,param_14,
                                  param_15);
    uVar11 = *puVar3;
    if (uVar11 != 0) {
  ...
  auVar12 = FUN_0022b580(auVar12,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0,
                         *(ushort *)(param_8 + 0x48),1,uVar5,uVar8,param_13,param_14,param_15);
  uVar4 = FUN_0022b490(auVar12,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0,
                       param_9,sVar7,uVar5,uVar8,param_13,param_14,param_15);
  if ((uVar4 & 1) == 0) {
    param_12 = 0;
LAB_0024ee98:
    bVar2 = false;
    ...
    auVar12 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_c0,8,sVar7,uVar5,uVar8,param_13,param_14,param_15);
    sVar7 = 4;
    FUN_001d0560(auVar12,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0,param_10,4
                 ,uVar5,uVar8,param_13,param_14,param_15);
    if (local_b8 == '\0') {
      sVar7 = 4;
      FUN_001d0560(extraout_q0_01,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0,
                   param_11,4,uVar5,uVar8,param_13,param_14,param_15);
      if (local_b8 == '\0') {
        sVar7 = 4;
        FUN_001d0560(extraout_q0_02,param_2,param_3,param_4,param_5,param_6,param_7,(long)&lStack_c0
                     ,param_12,4,uVar5,uVar8,param_13,param_14,param_15);
        if (local_b8 == '\0') {
          *(undefined8 *)(DAT_052a6b78 + 0x38) = DAT_052a6ba8;
          auVar12 = extraout_q0_03;
          if ((*(char *)(param_8 + 0x70) != '\0') &&
             (bVar2 = FUN_0022b600(param_8,0x10), auVar12 = extraout_q0_04, bVar2)) {
            bVar2 = true;
            goto LAB_0024ef1c;
          }
          uVar4 = FUN_0022a8f0(auVar12,param_2,param_3,param_4,param_5,param_6,param_7,param_8,
                               (long)param_9,(size_t)&lStack_c0,uVar5,uVar8,param_13,param_14,
                               param_15);
          param_12 = uVar4 & 0xffffffff;
          goto LAB_0024ee98;
        }
        local_dc = 0x8001000a;
        auVar12 = operator=((undefined4 *)alStack_110,&local_dc);
      }
      else {
        local_dc = 0x8001000a;
        auVar12 = operator=((undefined4 *)alStack_f8,&local_dc);
        plVar6 = alStack_f8;
      }
    }
    else {
      local_dc = 0x8001000a;
      auVar12 = operator=((undefined4 *)alStack_d8,&local_dc);
      plVar6 = alStack_d8;
    }
