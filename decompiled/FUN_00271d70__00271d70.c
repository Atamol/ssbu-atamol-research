...
LAB_00271ea8:
    ...
    auVar13 = FlagIsSet(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7,
                        (long)&lStack_c0,0x4e,sVar7,lVar8,uVar9,param_13,param_14,param_15);
    sVar7 = 8;
    ...
    if (local_b8 == '\0') {
      ...
      if (local_b8 == '\0') {
        auVar13 = FUN_00228610(auVar13,param_2,param_3,param_4,param_5,param_6,param_7,
                               ...
                               param_15);
        if (local_b8 == '\0') {
          *(undefined8 *)(DAT_052a6f30 + 0x268) = DAT_052a7190;
