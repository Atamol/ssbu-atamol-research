...
// name:      FUN_01af8f90
// mangled:   
// signature: undefined __cdecl FUN_01af8f90(undefined1[16] param_1, undefined1[16] param_2, float param_3, undefined1[16] param_4, undefined1[16] param_5, undefined1[16] param_6, undefined1[16] param_7, long param_8, uint * param_9)


void FUN_01af8f90(undefined1 param_1 [16],undefined1 param_2 [16],float param_3,
...

{
  ...
  uVar14 = param_1._0_4_;
  uVar15 = param_1._4_4_;
  uVar16 = param_1._8_8_;
  puVar13 = (uint *)(param_8 + 0xd4);
  if ((*puVar13 == *param_9) &&
     (iVar8 = libc_strcmp(), uVar14 = extraout_s0, uVar15 = extraout_var, uVar16 = extraout_var_03,
     iVar8 == 0)) {
    ...
    if (puVar13 != param_9) {
      ...
      while( true ) {
        ...
        *(char *)(lVar2 + 0xdc) = cVar3;
        ...
        uVar9 = uVar9 + 2;
        *(char *)(lVar2 + 0xdd) = cVar3;
      }
      *(undefined1 *)(param_8 + (uVar9 & 0xffffffff) + 0xdc) = 0;
      uVar12 = (uint)*(byte *)(param_8 + 0xdc);
      uVar11 = 0x811c9dc5;
      *(int *)(param_8 + 0xd8) = (int)uVar9;
      if (*(byte *)(param_8 + 0xdc) != 0) {
        pbVar10 = (byte *)(param_8 + 0xdd);
        do {
