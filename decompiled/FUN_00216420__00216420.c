...

{
  ...
  *param_8 = DAT_052a62a0 + 0x10;
  param_8[0x41] = 0;
  param_8[0x45] = 0;
  if ((((uint)param_11 >> 6 & 1) != 0) &&
     (plVar16 = FUN_001af950(auVar17,param_2,param_3,param_4,param_5,param_6,param_7,0x30,
                             extraout_x1,param_10,uVar12,lVar13,param_13,param_14,param_15),
     lVar9 = DAT_052a5eb8, plVar16 != (long *)0x0)) {
    ...
    *plVar16 = lVar9 + 0x10;
    ...
    if (*DAT_052a3da8 != '\0') {
      puVar10 = (uint *)FUN_01717c00(extraout_q0,param_2,param_3,param_4,param_5,param_6,param_7,
                                     *DAT_052a3db8,extraout_x1_00,param_10,uVar12,lVar13,param_13,
                                     param_14,param_15);
      uVar4 = *puVar10;
      if (uVar4 != 0) {
        lVar13 = **(long **)(lVar9 + 0xa0);
        if ((ulong)((*(long **)(lVar9 + 0xa0))[1] - lVar13 >> 3) <= (ulong)uVar4) {
                    /* WARNING: Subroutine does not return */
          FUN_001b1400(extraout_q0_00,param_2,param_3,param_4,param_5,param_6,param_7);
        }
        plVar11 = (long *)(*(long *)(lVar13 + (ulong)uVar4 * 8) + 0x20);
      }
    }
    lVar13 = 0;
    if (*plVar11 != 0) {
...
LAB_002166c4:
      ...
      if ((iVar14 == 0) && (*(char *)((long)plVar11 + 0xc) == '\0')) {
